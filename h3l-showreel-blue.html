  ...
  <head>
    ...
    <style>
      :root {
        ...
        --muted: #66728d;
        --white: #ffffff;
        --line: rgba(190, 212, 255, 0.44);
        --shadow: 0 26px 80px rgba(6, 24, 76, 0.34);
        --soft-shadow: 0 18px 44px rgba(38, 52, 201, 0.14);
        --cursor-x: 50%;
        --cursor-y: 18%;
        --active-accent: #3154e8;
        --active-accent-2: #f24ac3;
        --focus: 0 0 0 4px rgba(49, 84, 232, 0.28);
      }
      ...
      * {
      ...
      .site-shell {
        ...
        overflow-x: hidden;
        background:
          radial-gradient(circle at var(--cursor-x) var(--cursor-y), rgba(49, 84, 232, 0.2), transparent 24rem),
          radial-gradient(circle at 78% 15%, rgba(242, 74, 195, 0.12), transparent 18rem),
          radial-gradient(circle at 16% 38%, rgba(34, 200, 255, 0.12), transparent 20rem),
          linear-gradient(180deg, #07164b 0%, #2634c9 42%, #f8fbff 42%, #eef5ff 100%);
      }
      ...
      .light {
        background:
          radial-gradient(circle at 82% 8%, rgba(49, 84, 232, 0.12), transparent 17rem),
          radial-gradient(circle at 12% 42%, rgba(34, 200, 255, 0.12), transparent 20rem),
          radial-gradient(circle at 72% 58%, rgba(242, 74, 195, 0.08), transparent 18rem),
    ...
    <script>
      const PROJECTS = [
        ...
        },
        {
          ...
          poster: "assets/posters/grace-teaser-poster.jpg?v=3",
          runtime: "1:24",
          seconds: 84,
          accent: "#7b61ff",
          accent2: "#f24ac3",

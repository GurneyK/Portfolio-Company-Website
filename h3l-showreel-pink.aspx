  ...
  <head>
    ...
    <style>
      :root {
        ...
        --muted: #6b6384;
        --white: #ffffff;
        --line: rgba(215, 195, 255, 0.42);
        --shadow: 0 26px 80px rgba(25, 0, 82, 0.34);
        --soft-shadow: 0 18px 44px rgba(45, 24, 160, 0.16);
        --cursor-x: 50%;
        --cursor-y: 18%;
        --active-accent: #f24ac3;
        --active-accent-2: #2d3ed8;
        --focus: 0 0 0 4px rgba(242, 74, 195, 0.32);
      }
      ...
      * {
      ...
      .site-shell {
        ...
        overflow-x: hidden;
        background:
          radial-gradient(circle at var(--cursor-x) var(--cursor-y), rgba(242, 74, 195, 0.2), transparent 24rem),
          radial-gradient(circle at 76% 18%, rgba(33, 215, 255, 0.14), transparent 22rem),
          linear-gradient(180deg, #1a0054 0%, #2634c9 42%, #faf7ff 42%, #f4efff 100%);
      }
      ...
      .light {
        background:
          radial-gradient(circle at 82% 8%, rgba(242, 74, 195, 0.14), transparent 17rem),
          radial-gradient(circle at 12% 42%, rgba(33, 215, 255, 0.15), transparent 20rem),
